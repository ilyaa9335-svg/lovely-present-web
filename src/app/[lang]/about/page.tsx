        ...
        <div className="w-full rounded-2xl overflow-hidden shadow-lg mb-16 border-4 border-white bg-white">
          ...
          <div className="flex items-center justify-between p-5">
            <div className="flex items-center gap-3">
              <svg className="w-6 h-6 text-[var(--color-pink-brand)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
              </svg>
              <div>
                <p className="font-serif font-bold text-[var(--color-navy)]">5. Kvetna 1298/14</p>
                <p className="text-gray-500 text-sm">Prague 14000</p>
              </div>
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[var(--color-navy)] text-white font-semibold text-sm hover:bg-[var(--color-navy)]/90 transition-all shadow-md cursor-pointer"
            >
