...
export default function InstagramPreview({ lang }: InstagramPreviewProps) {
  ...
  return (
    <section className="py-14 px-4 bg-[var(--color-pink-light)]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          {previewProducts.map((product) => (
            ...
            >
              ...
              />
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-[var(--color-pink-brand)]/0 group-hover:bg-[var(--color-pink-brand)]/40 transition-colors duration-300 flex items-center justify-center">
                <svg
