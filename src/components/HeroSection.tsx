    ...
    <section className="relative bg-[var(--color-pink-light)] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-center">
          ...
          {/* Right: 3-image collage - takes 3 cols */}
          <div className="md:col-span-3 grid grid-cols-2 gap-3">
            {/* Large main image */}
            <div className="col-span-1 row-span-2 rounded-2xl overflow-hidden shadow-xl border-4 border-white aspect-[3/4]">
              <img src="/images/products/gisele.jpg" alt="Gisele bouquet" className="w-full h-full object-cover" />
            </div>
            {/* Top right image */}
            <div className="rounded-2xl overflow-hidden shadow-lg border-4 border-white aspect-square">
              <img src="/images/products/dubai.jpg" alt="Dubai bouquet" className="w-full h-full object-cover" />
            </div>
            {/* Bottom right image */}
            <div className="rounded-2xl overflow-hidden shadow-lg border-4 border-white aspect-square">
              <img src="/images/products/sweet-love.jpg" alt="Sweet Love bouquet" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </div>
