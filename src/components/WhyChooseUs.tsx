...
function FlowerIcon() {
  return (
    <div className="w-14 h-14 rounded-full bg-[var(--color-pink-light)] flex items-center justify-center">
      <svg className="w-7 h-7 text-[var(--color-pink-brand)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {reasons.map((reason, i) => {
            ...
            return (
              <div
                key={i}
                className="flex flex-col items-center text-center gap-3 p-6 rounded-xl bg-white shadow-sm hover:shadow-md transition-shadow border border-gray-50"
              >
                <IconComponent />
